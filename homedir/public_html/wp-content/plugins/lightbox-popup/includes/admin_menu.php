...
class wpdevart_lightbox_admin_menu{
	...
	$enable_disable=$enable_disable['eneble_lightbox_content'];
      ...
      <div class="admin_title"><h1>Lightbox Settings Page <a style="text-decoration:none;" target="_blank" href="http://wpdevart.com/wordpress-lightbox-plugin/"><span style="color: rgba(10, 154, 62, 1);"> (Upgrade to Pro Version)</span></a><a target="blank" href="<?php echo wpdevart_lightbox_support_url; ?>" class="wp_support">Support</a></h1></div>      
