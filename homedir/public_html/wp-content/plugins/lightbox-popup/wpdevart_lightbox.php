 ...
 * Description: Lightbox WordPress plugin is an high customizable and responsive product for displaying images and videos(YouTube and Vimeo lightbox) in popup. WordPress Lightbox plugin is one of the most popular and useful plugins for WordPress websites.
 * Version: 1.6.3
 * Author: wpdevart
